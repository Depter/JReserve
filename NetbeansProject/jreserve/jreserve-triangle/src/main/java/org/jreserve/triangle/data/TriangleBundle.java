...
public class TriangleBundle implements TriangularData, ChangeListener {
    ...
    private TreeSet<TriangleModification> modifications = new TreeSet<TriangleModification>();
    ...
    private void checkNewModification(TriangleModification modification) {
    ...
    private void linkModifications() {
        ...
        for(TriangleModification modification : modifications) {
    ...
    public void removeModification(TriangleModification modification) {
        TriangleModification contained = getContainedModification(modification);
        if(contained != null) {
    ...
    private TriangleModification getContainedModification(TriangleModification modification) {
        for(TriangleModification m : modifications)
