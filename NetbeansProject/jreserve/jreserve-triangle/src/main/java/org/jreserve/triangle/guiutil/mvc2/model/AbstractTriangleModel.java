...
public abstract class AbstractTriangleModel implements TriangleModel {
    ...
    public LayerCriteria createCriteria(int row, int column) {
        ...
        setRowCriteria(criteria, row);
        setColumnCriteria(criteria, column);
        return criteria;
    }

    private void setRowCriteria(LayerCriteria criteria, int row) {
    ...
    private void setColumnCriteria(LayerCriteria criteria, int column) {
