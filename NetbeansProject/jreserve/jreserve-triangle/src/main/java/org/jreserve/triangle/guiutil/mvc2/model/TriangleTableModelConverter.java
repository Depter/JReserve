...
import org.jreserve.triangle.guiutil.mvc2.data.DefaultLayerModel;
import org.jreserve.triangle.guiutil.mvc2.data.Layer;
import org.jreserve.triangle.guiutil.mvc2.data.LayerCriteria;
import org.jreserve.triangle.guiutil.mvc2.data.TriangleLayerModel;
...
public class TriangleTableModelConverter implements TableModel {
    ...
    public int getColumnCount() {
        return triangleModel.getColumnModel().size();
    }

    @Override
    public String getColumnName(int column) {
        return triangleModel.getColumnModel().getTitle(column);
    }
