...
public class TriangleTable extends JTable {
    ...
    private LayerTextEditor editor;
    ...
    public void removeLayer(Layer layer) {
        int position = model.getPosition(layer);
        if(position >= 0)
    ...
    public void setLayerEditor(LayerTextEditor editor) {
        ...
        super.setDefaultEditor(Object.class, editor);
        super.setDefaultEditor(List.class, editor);
    }
    
    public LayerCriteria createCellCriteria(int row, int column) {
        return model.createCellCriteria(row, column);
    }
