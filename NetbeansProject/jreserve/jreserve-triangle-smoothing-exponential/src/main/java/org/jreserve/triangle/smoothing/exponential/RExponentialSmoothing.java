...
public class RExponentialSmoothing implements RFunction {
    ...
    private final static String NAME = "smoothing.exponential";
    ...
    public static String getSmoothing(String triangle, String x, String y, String used, double alpha) {
        String source = "%s(%s, %s, %s, %s, %f)";
        return String.format(source, NAME, triangle, x, y, used, alpha);
    }
