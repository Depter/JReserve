 ...
 */
@Messages({
    "LBL.DevelopmentPeriodsGraph.Title=Development periods",
    "LBL.DevelopmentPeriodsGraph.Axis=Accident periods"

})
public class DevelopmentPeriodsGraph extends TriangleSeriesGraph<Integer, Date> {
    
    private DateRenderer dateRenderer;
    
    public DevelopmentPeriodsGraph(TriangleWidget widget) {
        super(Bundle.LBL_DevelopmentPeriodsGraph_Title(), widget);
    }
    
    @Override
    protected String getDomainAxisName() {
        return Bundle.LBL_DevelopmentPeriodsGraph_Axis();
    }
