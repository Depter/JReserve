...
final class CreateDatabaseVisualPanel2 extends JPanel {
    ...
    private void initComponents() {
        ...
        nameText.setText(org.openide.util.NbBundle.getMessage(CreateDatabaseVisualPanel2.class, "CreateDatabaseVisualPanel2.nameText.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(passLabel, Bundle.CTL_passLabel());

        passText.setText(org.openide.util.NbBundle.getMessage(CreateDatabaseVisualPanel2.class, "CreateDatabaseVisualPanel2.passText.text")); // NOI18N
