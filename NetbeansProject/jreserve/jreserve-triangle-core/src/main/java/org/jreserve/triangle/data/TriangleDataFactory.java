...
public class TriangleDataFactory {
    ...
    public TriangleDataFactory(TriangleGeometry geometry) {
        this.geometry = geometry.copy();
    }
    
    public TriangularData buildTriangle(List<ClaimValue> values) {
    ...
    private TriangleData createTriangleInput() {
        Date[] accidents = getAccidentDates();
        Date[][] developments = getDevelopmentDates();
        double[][] data = getValues();
        return new TriangleData(accidents, developments, data);
    }
