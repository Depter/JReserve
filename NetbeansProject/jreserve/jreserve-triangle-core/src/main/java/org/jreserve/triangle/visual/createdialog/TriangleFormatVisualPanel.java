...
import org.jreserve.triangle.data.TriangleDataFactory;
...
class TriangleFormatVisualPanel extends JPanel {
    ...
    private void createTriangleData() {
        data = createData();
        triangle.setSource(new DummydataProvider(data));
        fireChangeEvent();
    }
    ...
    private TriangularData createData() {
        ...
        return new TriangleDataFactory(geometry).buildTriangle(datas);
    }
    ...
    private class DummydataProvider implements TriangularData.Provider {
        
        private TriangularData data;

        public DummydataProvider(TriangularData data) {
            this.data = data;
        }
