...
@TableGenerator(
    name="org.jreserve.project.entities.DataType",
    ...
    pkColumnValue="org.jreserve.project.entities.DataType"
)
public class DataType implements Serializable {
    ...
    @Id 
    @GeneratedValue(strategy=GenerationType.TABLE, generator="org.jreserve.project.entities.DataType")
