 ...
 */
@Messages({
    "CTL_dialogTitle=Open Oracle Database"
})
public class OpenDialogWizard {
    ...
    public OracleDatabase openDatabase() {
        initWizard();
    ...
    private void initWizard() {
        panels.add(new OpenDialogWizardPanel1());
        panels.add(new OpenDialogWizardPanel2());
        initDescriptors();
        createWizard();
    }
